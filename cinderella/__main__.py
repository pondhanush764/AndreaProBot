...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya,{} Here..\nHow can I help you?🙂".format(bot.first_name),reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="Support Group 😇",url="https://t.me/kittysupport")]]))
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help ❔",callback_data="help_back"),InlineKeyboardButton(text="Creator 🔱",url="https://t.me/THE_BOSS_OF_TELEGRAM")]]
